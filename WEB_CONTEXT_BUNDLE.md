...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-961-erd-s-problem-961-c5c92f3c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-961"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-961-erd-s-problem-961-c5c92f3c-v1",
      "problem_contract_sha256": "4b0a25f1e33cd9ff08a5a7ddee51a5ef468147fb16601036c0765128933b265d",
      "problem_id": "problem:um-ep-961-erd-s-problem-961-c5c92f3c",
      "route_id": "route:um-ep-961-erd-s-problem-961-c5c92f3c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-961-erd-s-problem-961-c5c92f3c-source-fidelity-01",
      "graph_id": "graph:um-ep-961-erd-s-problem-961-c5c92f3c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-961-erd-s-problem-961-c5c92f3c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-961-erd-s-problem-961-c5c92f3c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f(k)$ be the minimal $n$ such that every set of $n$ consecutive integers $>k$ contains an integer divisible by a prime $>k$. Estimate $f(k)$."
          },
          "statement_sha256": "5d542f858e46f34eb221d7a683957135aa44650ed5944e2e081ec1788b7f1764"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-961-erd-s-problem-961-c5c92f3c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-961-erd-s-problem-961-c5c92f3c-root",
      "route_id": "route:um-ep-961-erd-s-problem-961-c5c92f3c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-961-575f1f01c90b",
        "url": "https://www.unsolvedmath.com/problems/EP-961"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
